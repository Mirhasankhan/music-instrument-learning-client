...
const Instructors = () => {
    ...
    return (
        <div>
            <h1 className='animate__animated animate__backInRight text-center font-medium text-2xl md:text-3xl text-purple-600 my-8 border-b-2 pb-3'>Our Instructors</h1>
